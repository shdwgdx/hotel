                                    ...
                                    <div class="row_info_hotel ">
                                        @if ($advItem->moderated == 1 && $advItem->published == 0)
                                            <div class="item_info_hotel exclamation_mark_danger_icon">
                                                Объявление было отклонено. Причина: {{ $advItem->reject_message }}
                                            </div>
                                    ...
                                    <div class="card_info_price_wrapper">
                                        ...
                                        <div class="left_block">
                                            <div class="price_value">
                                                {{-- @if (strtotime($advItem->expired_date) - strtotime(now()->setTimezone('Europe/Moscow')) > 0) --}}
                                                @if ($advItem->published && strtotime($advItem->expired_date) - strtotime(now()) < 0)
