    ...
    <main class="admin_main">
        ...
        <div class="container_best_hotel">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <?php if($advertisemens->published && strtotime($advertisemens->expired_date) - strtotime(now()) < 0): ?>
                            <div class="modal_btn_wrapper add_hotel_btn_wrapper m-0">
                                <form action="<?php echo e(route('profile-republish')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="text" name="id" id="id"
                                        value="<?php echo e($advertisemens->id); ?>" class="d-none">
                        ...
                        <?php else: ?>
                            <div class="modal_btn_wrapper add_hotel_btn_wrapper">
                                <button class="btn_modal" onclick="editUploadAdvertisementImages()">Опубликовать</button>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('Profile.Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shdwg\Desktop\ABHAZ\resources\views/Profile/edit.blade.php ENDPATH**/ ?>