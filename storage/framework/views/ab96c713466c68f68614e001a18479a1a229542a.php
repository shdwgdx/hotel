<?php $__env->startSection('content'); ?>
                    ...
                    <div class="row row_mt40">
                        <div class="swiper_best_hotel swiper_popular_place">
                            ...
                            <div class="swiper-wrapper">
                                <!-- Slides -->
                                <?php $__currentLoopData = $advertisements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="body_hotel_card">
                                            <div class="img_wrapper">
                                                <div class="swiper swiper-popular">
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        <!-- Slides -->
                                                        <?php $__currentLoopData = $advItem->photoUrl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advItemImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="swiper-slide"><img class="obg-f-cover"
                                                                    src="/storage/<?php echo e($advItemImg->url); ?>" alt="">
                                                            </div>
                                            ...
                                            <div class="content_wrapper">
                                                ...
                                                <div class="card_info_price_wrapper">
                                                    <div class="left_block">
                                                        <div class="price_value">€<?php echo e($advItem->price); ?> <span>/
                                                                ночь</span>
                                                        </div>
                                                        <div class="price_description"><span>*Цена варьируется</span>
                                                        </div>
                                                    </div>
                                                    <a href="<?php echo e(route('advertisement-page', $advItem->id)); ?>"
    ...
    <?php if(count($advertisemensPopular) > 0): ?>
        <div class="hotel_carusel_block margin170">
            <div class="container">
                ...
                <div class="container">
                    <div class="row row_mt40">
                        <div class="swiper_best_hotel swiper_popular_place">
                            ...
                            <div class="swiper-wrapper">
                                <!-- Slides -->
                                <?php $__currentLoopData = $advertisemensPopular; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide">
                                        <div class="body_hotel_card">
                                            <div class="img_wrapper">
                                                <div class="swiper swiper-popular">
    ...
    <script>
        ...
        //         center: {
        //             lat: <?php echo e($advertisemensMap->first()->lat); ?>,
        //             lng: <?php echo e($advertisemensMap->first()->lng); ?>,
        //         },
        //         zoom: 8,
        //     });
        ...
        //     //     disableAutoPan: true,
        //     // });
        // <?php $__currentLoopData = $advertisemensMap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advertisement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        //     const marker_<?php echo e($advertisement->id); ?> = new google.maps.marker.AdvancedMarkerView({
        //         position: {
        //             lat: <?php echo e($advertisement->lat); ?>,
        //             lng: <?php echo e($advertisement->lng); ?>,
        //         },
        //         map: map,
        //         content: priceTag,
        //         // label: "<?php echo e($advertisement->price); ?>",
        //         // icon: "https://pastenow.ru/4dbadae948e8d68da3511e5f443058de.png",
        //     });
        //     // marker_<?php echo e($advertisement->id); ?>.addListener("click", () => {
        //     //     infoWindow.setContent("<?php echo e($advertisement->name); ?>");
        //     //     infoWindow.open(map, marker_<?php echo e($advertisement->id); ?>);
        //     // });
        // <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        // }
        ...
        <?php if(isset($advertisemensMap)): ?>
            {
                function initMap() {
                    ...
                    <?php $__currentLoopData = $advertisemensMap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advertisement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        const priceTag<?php echo e($advertisement->id); ?> = document.createElement("div");
                        // const marker_<?php echo e($advertisement->id); ?> = new google.maps.marker.AdvancedMarkerView({
                        //     position: {
                        //         lat: <?php echo e($advertisement->lat); ?>,
                        //         lng: <?php echo e($advertisement->lng); ?>,
                        ...
                        priceTag<?php echo e($advertisement->id); ?>.className = "price-tag";
                        priceTag<?php echo e($advertisement->id); ?>.textContent = "<?php echo e($advertisement->price); ?>";

                        const markerView<?php echo e($advertisement->id); ?> = new google.maps.marker.AdvancedMarkerView({
                            map,
                            position: {
                                lat: <?php echo e($advertisement->lat); ?>,
                                lng: <?php echo e($advertisement->lng); ?>,
                            },
                            content: priceTag<?php echo e($advertisement->id); ?>,

                        });
                        google.maps.event.addListener(markerView<?php echo e($advertisement->id); ?>, 'click', function() {
                            window.location.href = '/advertisement/<?php echo e($advertisement->id); ?>';
                        });
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                }
...
<?php echo $__env->make('Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shdwg\Desktop\ABHAZ\resources\views/index-page.blade.php ENDPATH**/ ?>