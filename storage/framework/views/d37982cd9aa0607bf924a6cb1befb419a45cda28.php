...
<?php $__env->startSection('content'); ?>
    <main class="admin_main">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title_main">Активные объявления</div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('Profile.Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shdwg\Desktop\ABHAZ\resources\views/Profile/active-advertisements.blade.php ENDPATH**/ ?>