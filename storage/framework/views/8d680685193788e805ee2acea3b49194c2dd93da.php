...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <div class="guests_item adults_counter">
                                        ...
                                        <div class="wrapper_counter_item_guests">
                                            ...
                                            <input class="count_input_geusts"
                                                value="<?php if($rooms): ?> <?php echo e($rooms); ?> <?php else: ?> 1 <?php endif; ?>">
                                            <button class="btn_plus"></button>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        // Filter parametr
        let filterState = {
            "part_island_id": <?php if(isset($data['part_island_id_apartment'])): ?>
                <?php echo e($data['part_island_id_apartment']); ?>

            <?php else: ?>
                ''
            <?php endif; ?> ,
            "district_id": <?php if(isset($data['district_id_apartment'])): ?>
                <?php echo e($data['district_id_apartment']); ?>

            <?php else: ?>
                ''
            <?php endif; ?> ,
            "flat": <?php if(isset($typeHouse['flat_apartment'])): ?>
                "<?php echo e($typeHouse['flat_apartment']); ?>"
            <?php else: ?>
                0
            <?php endif; ?> ,
            "villa": <?php if(isset($typeHouse['villa_apartment'])): ?>
                "<?php echo e($typeHouse['villa_apartment']); ?>"
            <?php else: ?>
                0
            <?php endif; ?> ,
            "penthouse": <?php if(isset($typeHouse['penthouse_apartment'])): ?>
                "<?php echo e($typeHouse['penthouse_apartment']); ?>"
            <?php else: ?>
                0
            <?php endif; ?> ,
            "townhouse": <?php if(isset($typeHouse['townhouse_apartment'])): ?>
                "<?php echo e($typeHouse['townhouse_apartment']); ?>"
            <?php else: ?>
                0
            <?php endif; ?> ,
            "rooms": <?php if(isset($rooms)): ?>
                <?php echo e($rooms); ?>
    ...
    <script src="<?php echo e(asset('nouislider/nouislider.js')); ?>"></script>
    <script
        ...
        function initMap() {
            ...
            <?php $__currentLoopData = $advertisemensMap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advertisement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                google.maps.event.addListener(markerView<?php echo e($advertisement->id); ?>, 'click', function() {
                    window.location.href = '/advertisement-sale/<?php echo e($advertisement->id); ?>';
                });
...
<?php echo $__env->make('Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shdwg\Desktop\ABHAZ\resources\views/search-sale.blade.php ENDPATH**/ ?>