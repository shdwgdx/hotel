...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('nouislider/nouislider.css')); ?>">
                    ...
                    <div class="wrapper_flex_row">
                        <div class="change_lang_wrapper">
                            <a href="<?php echo e(route('locale', 'ru')); ?>"
                                class="item_lang <?php if(__('main.select_lang') == 'ru'): ?> active <?php endif; ?>">RU</a>
                            <div class="line"></div>
                            <a href="<?php echo e(route('locale', 'en')); ?>"
                                class="item_lang <?php if(__('main.select_lang') == 'en'): ?> active <?php endif; ?>">EN</a>
                            <div class="line"></div>
                            <a href="<?php echo e(route('locale', 'es')); ?>"
                                class="item_lang <?php if(__('main.select_lang') == 'es'): ?> active <?php endif; ?>">ES</a>
                        </div>
                        <div class="right_top_header_wrapper">
                            ...
                            <div class="chosen_one_star_wrapper">
                                <a href="<?php echo e(route('favorites-page')); ?>"
            ...
            <div class="main_header">
                <div class="container">
                    <div class="wrapper_row_header">
                        <a href="<?php echo e(route('index-page')); ?>" class="logo_header">Logo</a>
                        <ul class="menu_list">
                            <li class="item_double_menu_list"><a href="#" class="double_menu_list">Услуги</a>
                                <ul class="menu_list_double">
                                    <li class="menu_item <?php if(request()->route()->uri == '/'): ?> active <?php endif; ?>"><a
                                            href="<?php echo e(route('index-page')); ?>">Аренда</a>
                                    </li>
                                    <li class="menu_item <?php if(request()->route()->uri == 'buy'): ?> active <?php endif; ?>"><a
                                            href="<?php echo e(route('search-sale-page')); ?>">Продажа</a></li>
                                    <li class="menu_item <?php if(request()->route()->uri == 'service'): ?> active <?php endif; ?>"><a
                                            href="<?php echo e(route('service-page')); ?>">Экскурсии</a></li>
                                    <li class="menu_item <?php if(request()->route()->uri == 'transfer'): ?> active <?php endif; ?>"><a
                                            href="<?php echo e(route('transfer-page')); ?>">Трансфер</a></li>
                                    <li class="menu_item <?php if(request()->route()->uri == 'contacts'): ?> active <?php endif; ?>"><a
                                            href="<?php echo e(route('contact-page')); ?>"><?php echo e(__('main.Contacts')); ?></a></li>
                                </ul>
                            </li>
                            ...
                            <li class="menu_item desctop mob">
                                <a href="<?php echo e(route('favorites-page')); ?>" class="chosen_one_star">
                                    Избранное
                                </a>
                            </li>
                            <li class="menu_item desctop <?php if(request()->route()->uri == '/'): ?> active <?php endif; ?>"><a
                                    href="<?php echo e(route('index-page')); ?>">Аренда</a>
                            </li>
                            <li class="menu_item desctop <?php if(request()->route()->uri == 'buy'): ?> active <?php endif; ?>"><a
                                    href="<?php echo e(route('search-sale-page')); ?>">Продажа</a></li>
                            <li class="menu_item desctop <?php if(request()->route()->uri == 'service'): ?> active <?php endif; ?>"><a
                                    href="<?php echo e(route('service-page')); ?>">Экскурсии</a></li>
                            <li class="menu_item desctop <?php if(request()->route()->uri == 'transfer'): ?> active <?php endif; ?>"><a
                                    href="<?php echo e(route('transfer-page')); ?>">Трансфер</a></li>
                            <li class="menu_item desctop <?php if(request()->route()->uri == 'contacts'): ?> active <?php endif; ?>"><a
                                    href="<?php echo e(route('contact-page')); ?>"><?php echo e(__('main.Contacts')); ?></a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 col-lg-3">
                            <ul class="footer_menu_list">
                                <li class="footer_menu_item title"><a href="<?php echo e(route('service-page')); ?>">Услуги</a>
                                </li>
                                <li class="footer_menu_item"><a href="<?php echo e(route('service-page')); ?>">Аренда
                                    </a></li>
                                <li class="footer_menu_item"><a href="<?php echo e(route('service-page')); ?>">Продажа
                                    </a></li>
                                <li class="footer_menu_item"><a href="<?php echo e(route('service-page')); ?>">Экскурсии</a>
                                </li>
                                <li class="footer_menu_item"><a href="<?php echo e(route('transfer-page')); ?>">Трансфер</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 col-md-4 col-lg-3">
                            <ul class="footer_menu_list">
                                ...
                                <li class="footer_menu_item"><a
                                        href="<?php echo e(route('contact-page')); ?>"><?php echo e(__('main.Contacts')); ?></a></li>
                                <li class="footer_menu_item"><a href="<?php echo e(route('terms-page')); ?>">Политика
                                        возврата</a>
                                </li>
                                <li class="footer_menu_item"><a href="<?php echo e(route('privacy-policy-page')); ?>">Политика
                                        безопасности</a></li>
                                <li class="footer_menu_item"><a href="<?php echo e(route('return-policy-page')); ?>">Политика
                                        файлов cookie</a></li>
                                <li class="footer_menu_item"><a href="<?php echo e(route('cookies-page')); ?>">Условия
...
<script>
<?php /**PATH C:\Users\shdwg\Desktop\ABHAZ\resources\views/Layout/main.blade.php ENDPATH**/ ?>