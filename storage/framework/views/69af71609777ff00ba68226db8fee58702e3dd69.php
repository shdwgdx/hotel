...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(strtotime($advertisement->expired_date) - strtotime(now()) < 0): ?>
    ...
    <main <?php if(strtotime($advertisement->expired_date) - strtotime(now()->setTimezone('Europe/Moscow')) < 0): ?> class="opacity-25" <?php endif; ?>>

        <div class="container container_breadcrumbs">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('index-page')); ?>">Главная</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('search-page')); ?>">Фильтр</a></li>
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-8">
                    <div class="swiperHotelPhoto">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <?php $__currentLoopData = $advertisement->photoUrl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advItemImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide"><img src="/storage/<?php echo e($advItemImg->url); ?>" alt=""></div>
                            ...
                            <div class="image-mini-slider__wrapper swiper-wrapper">
                                ...
                                <?php $__currentLoopData = $advertisement->photoUrl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advItemImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="image-mini-slider__slide swiper-slide"><img
                                            src="/storage/<?php echo e($advItemImg->url); ?>" alt=""></div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                ...
                <div class="col-12 col-md-4 col-lg-4">
                    <div class="body_dashbord_hotel" id="dashbord_hotel">
                        ...
                        <div class="price_value">€<?php echo e($advertisement->price); ?></div>
                        ...
                        <div class="wpapper_search_input guests_count_wrapper">
                            ...
                            <div class="input_view"><?php echo e($advertisement->guests); ?> гостей</div>
                        ...
                        <div class="row_body_dashbord_hotel">
                            ...
                            <div class="body_dashbord_hotel__full_price">€<?php echo e($advertisement->price); ?></div>
                        </div>
                ...
                <div class="col-12 col-md-8 col-lg-8">
                    <div class="body_block_info ">
                        ...
                        <div class="description_block_info block_hide">
                            <?php if(__('main.select_lang') == 'en'): ?>
                                <?php echo e($advertisement->description_en); ?>

                            <?php endif; ?>
                            <?php if(__('main.select_lang') == 'es'): ?>
                                <?php echo e($advertisement->description_es); ?>

                            <?php endif; ?>
                            <?php if(__('main.select_lang') == 'ru'): ?>
                                <?php echo e($advertisement->description); ?>

                            <?php endif; ?>
                            <?php echo e(strlen($advertisement->description)); ?>

                        </div>
                        <?php if(__('main.select_lang') == 'en' && strlen($advertisement->description) > 300): ?>
                            <div class="roll_up_block_info" onclick="viewAll(this)">Смотреть все</div>
                        <?php endif; ?>
                        <?php if(__('main.select_lang') == 'es' && strlen($advertisement->description) > 300): ?>
                            <div class="roll_up_block_info" onclick="viewAll(this)">Смотреть все</div>
                        <?php endif; ?>
                        <?php if(__('main.select_lang') == 'ru' && strlen($advertisement->description) > 300): ?>
                            <div class="roll_up_block_info" onclick="viewAll(this)">Смотреть все</div>
                        <?php endif; ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form action="<?php echo e(route('booked-api')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="text" name="id_advertisement" style="display: none"
                                value="<?php echo e($advertisement->id); ?>">
    ...
    <script>
        ...
        function drawCookie() {
            ...
            if (getCookie('favorites')) {
                ...
                let id = <?php echo e($advertisement->id); ?>;
        ...
        //     let body = {
        //         id_advertisement: <?php echo e($advertisement->id); ?>,
        ...
        function addOrDelFavorite() {
            ...
            let img = '/storage/<?php echo e($advertisement->photoUrl[0]->url); ?>';
            let id = <?php echo e($advertisement->id); ?>

            let advertisement = {
                id,
                title: "<?php echo e($advertisement->name); ?>",
                adress: "<?php echo e($advertisement->adress); ?>",
                price: "<?php echo e($advertisement->price); ?>",
                img
            };
            let star = document.querySelectorAll('.star_chosen_one')[0];
            if (getCookie('favorites')) {
...
<?php echo $__env->make('Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shdwg\Desktop\ABHAZ\resources\views/advertisement.blade.php ENDPATH**/ ?>