                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="wpapper_search_input">
                        ...
                        <input id="name" type="text"
                            class="form-control text input_view <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="wpapper_search_input">
                        ...
                        <input id="phone" type="phone"
                            class="form-control text input_view <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="wpapper_search_input">
                        ...
                        <input id="avatar" type="file"
                            class=" text input_view form-control  <?php $__errorArgs = ['avatar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="avatar"
                            value="<?php echo e(old('avatar')); ?>" autocomplete="avatar">
...
<?php echo $__env->make('Profile.Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shdwg\Desktop\ABHAZ\resources\views/Profile/register.blade.php ENDPATH**/ ?>