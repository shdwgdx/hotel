            ...
            <div class="container">
                <div class="row">
                    <div class="modal_btn_wrapper add_hotel_btn_wrapper me-4">
                        <a href="/admin/delete/<?php echo e($advertisemens->id); ?>"><button
                    ...
                    <div class="col col-auto ms-auto d-flex">
                        <div class="modal_btn_wrapper add_hotel_btn_wrapper">
                            <form action="<?php echo e(route('publicate-advertisement-admin')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="text" name="id" id="id" value="<?php echo e($advertisemens->id); ?>"
                                    class="d-none">
                ...
                <div>
                    <form action="<?php echo e(route('reject-advertisement-admin')); ?>" method="POST" class="d-flex">
                        <?php echo csrf_field(); ?>
                        <input type="text" name="id" id="id" value="<?php echo e($advertisemens->id); ?>"
                            class="d-none">
...
<?php echo $__env->make('Admin.Layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shdwg\Desktop\ABHAZ\resources\views/Admin/edit.blade.php ENDPATH**/ ?>